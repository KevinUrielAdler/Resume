...
\begin{paracol}{2}
  ...
  {Desarrollé {\href{https://github.com/KevinUrielAdler/Allearning}{\color{blue}
  ...
  {Creé {\href{https://github.com/KevinUrielAdler/AvZ}{\color{blue}
  ...
  % {\color{blue}herramienta\color{black}}} para calcular máximos y mínimos de
  ...
  \end{itemize}
  \divider
  \cvevent{{\href{https://drive.google.com/file/d/1U6rwow80xCz0LrepnSFyvGuc5V7Hr1Id/view?usp=sharing}{\color{blue}Carrera Técnica\color{black}}} en Informática}
  ...
  \cvevent{{\href{https://drive.google.com/file/d/1a9Y24AIVQ5aGS7OPvPD1qg4wDesXFmRi/view?usp=sharing}{\color{blue}Segundo Lugar\color{black}}} (Concurso estatal)}
